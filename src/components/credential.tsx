      ...
      <View className="bg-black/20 self-stretch items-center pb-6 border-white/10 mx-3 rounded-2xl -mt-5">
        ...
        >
          <View className="w-full flex-row items-center justify-between">
            <Text className="text-zinc-50 text sm font-bol">
              {data.eventTitle}
            </Text>
            <Text className="text-zinc-50 text sm font-bol">#{data.id}</Text>
          </View>
        ...
        {data.image ? (
          ...
          <TouchableOpacity
            activeOpacity={0.9}
            className="h-36 w-36 rounded-full -mt-24 bg-gray-400  items-center justify-center"
